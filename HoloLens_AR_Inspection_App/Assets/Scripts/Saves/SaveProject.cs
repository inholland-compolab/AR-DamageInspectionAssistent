...
{
    string filePath = @"D:\JSONSaveFolder";     //Assign save folder      (PC *Editor*)
    //string filePath = @"???";     //Assign save folder      (HoloLens *Build*)
    ...
    public void Save() {
        ...
        string path = filePath + "/NoseConeProject_"+projectName+".json";   //Set file path
